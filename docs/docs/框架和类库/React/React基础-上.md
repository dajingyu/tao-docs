...
![image.png](React基础-上/09.png)
## 修改对象状态
 对于对象类型的状态变量，应该始终给set方法一个`全新的对象` 来进行修改

![image.png](React基础-上/10.png)
# 组件的基础样式处理
